export default function About() {
  return (
    ...
    >
      <div className="relative flex h-screen w-screen items-center justify-center bg-black bg-grid-white/[0.2]">
        ...
        <div className="relative z-20 flex flex-col items-center">
          <p className="text-3xl font-semibold text-neutral-400 sm:text-5xl">
            Hi, my name is
          </p>
          <p className="bg-gradient-to-b from-neutral-100 to-neutral-400 bg-clip-text pt-4 text-5xl font-bold text-transparent sm:text-8xl">
            Dempster Tay
          </p>
          <div className="flex flex-col items-center text-center">
            <p className="max-w-xs pt-6 text-neutral-400 sm:max-w-lg sm:pt-10 sm:text-lg">
            ...
            <p className="max-w-xs pt-6 text-neutral-400 sm:max-w-lg sm:pt-3 sm:text-lg">
